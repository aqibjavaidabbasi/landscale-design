                                                    ...
                                                    <form class="form m-5">
                                                        ...
                                                        <div class="p-10 custom-border-color-pale custom-border-radius-15">
                                                            <div class="d-flex justify-content-between align-items-center">
                                                                <div>
                                                                    <span class="custom-font-style-headings custom-text-primary">Objectives</span>
                                                            ...
                                                            <div class="row mt-5">
                                                                <div class="col-md-12 mb-5">
                                                                    <div class="row mt-5">
                                                                        <div class="col-md-6">
                                                                            <div class="ml-1 p-5">
                                                                                <label for="landscape_obj_1" class="custom-font-style-text-bolder custom-text-primary d-inline">Objective 1*</label>
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            ...
                                                                            <div class="ml-1 p-5">
                                                                                <label for="landscape_obj_2" class="custom-font-style-text-bolder custom-text-primary d-inline">Objective 2</label>
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            ...
                                                                            <div class="ml-1 p-5">
                                                                                <label for="landscape_obj_3" class="custom-font-style-text-bolder custom-text-primary d-inline">Objective 3</label>
                                                                    ...
                                                                    <div class="mt-10 d-flex justify-content-between align-items-center custom-margin">
                                                                        <div class="assesment-responsive">
                                                                            <a href="./overview.php" id="back-btn" class="custom-bg-grey custom-text-primary d-inline-block custom-border-radius-35 border-0 px-8 py-2" data-wizard-type="action-prev">
                                                                                Back
                                                                            </a>
                                                                        </div>
                                                                        <div class="assesment-responsive-btn-block">
                                                                            <a href="./boundary.php" id="next-btn" class="custom-bg-primary custom-text-light-pale d-inline-block custom-border-radius-35 border-0 px-8 py-2 mr-2" data-wizard-type="action-next">Next</a>
