                                                    ...
                                                    <form class="form m-5">
                                                        ...
                                                        <div class="p-10 custom-border-color-pale custom-border-radius-15">
                                                            <div class="d-flex justify-content-between align-items-center">
                                                                <span class="custom-font-style-subheadings custom-text-primary">Preliminary Boundary</span>
                                                                ...
                                                                <div class="col-md-12 mb-5">
                                                                    ...
                                                                    <div class="mt-10 d-flex justify-content-between align-items-center custom-margin">
                                                                        <div class="assesment-responsive">
                                                                            <a href="./objectives.php" id="back-btn" class="custom-bg-grey custom-font-style-small custom-text-primary d-inline-block custom-border-radius-35 border-0 px-8 py-2" data-wizard-type="action-prev">
                                                                                Back
                                                                            </a>
                                                                        </div>
                                                                        <div class="assesment-responsive-btn-block">
                                                                            <a href="./payment_plan.php" id="next-btn" class="custom-bg-primary custom-font-style-small custom-text-light-pale d-inline-block custom-border-radius-35 border-0 px-8 py-2 mr-2" data-wizard-type="action-next">Next</a>
