                                                    ...
                                                    <form class="form m-5">
                                                        ...
                                                        <div class="p-10 border-color-pale br-15">
                                                            <div class="d-flex justify-content-between align-items-center">
                                                                <span class="font-subheading text-primary">Preliminary Boundary</span>
                                                            ...
                                                            <div class="row mt-5">
                                                                <div class="col-md-12 mb-5">
                                                                    ...
                                                                    <div class="d-flex justify-content-center align-items-center mt-5 w-100">
                                                                        <button type="button" class="bg-light-yellow text-primary border-color-pale d-flex justify-content-center align-items-center w-25 br-15 border-0 py-5 mr-2">
                                                                            <span class="mr-3 mt-1">
                                                                                <i class="icn-location"></i>
                                                                            </span>
                                                                            <span class="d-linline-block w-0 font-text">Other landscapes
                                                                                boundaries</span>
                                                                        </button>
                                                                        <button type="button" class="bg-light-blue text-primary border-color-pale d-flex justify-content-center align-items-center w-25 br-15 border-0 py-5 ml-2">
                                                                            <span class="mr-3 mt-1">
                                                                                <i class="icn-location"></i>
                                                                            </span>
                                                                            <span class="d-linline-block font-text">Your assessment</span>
                                                                        </button>
                                                                    </div>
                                                                    ...
                                                                    <div class="mt-10 d-flex justify-content-between align-items-center custom-margin">
                                                                        <div class="assesment-responsive">
                                                                            <a href="./objectives.php" id="back-btn" class="btn-grey c-btn-sm d-flex align-items-center justify-content-center" data-wizard-type="action-prev">
                                                                                Back
                                                                            </a>
                                                                        </div>
                                                                        <div class="d-flex align-items-center">
                                                                            <a href="./payment_plan.php" id="next-btn" class="c-btn-primary c-btn-sm d-flex align-items-center justify-content-center" data-wizard-type="action-next">Next</a>
