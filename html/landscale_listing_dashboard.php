                                            ...
                                            <div class="card w-100 h-100 p-5 custom-bg-white">
                                                <!-- <div class="row mt-10">
                                                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                        <a href="#" class="custom-bg-primary p-4 w-100 h-100 custom-text-light-pale d-block card-hover">
                                                            <div class="d-flex flex-column">
                                                                <span class="custom-font-style-headings">26</span>
                                                                <span class="custom-font-style-small-text">Pending Reviews</span>
                                                            </div>

                                                        </a>
                                                    </div>
                                                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                        <a href="#" class="custom-bg-light-yellow p-4 w-100 h-100 custom-text-primary d-block">
                                                            <div class="d-flex flex-column">
                                                                <span class="custom-font-style-headings">9</span>
                                                                <span class="custom-font-style-small-text">Assessment Applications</span>
                                                            </div>

                                                        </a>
                                                    </div>
                                                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                        <a href="#" class="custom-bg-cyan p-4 custom-text-white w-100 h-100 d-block card-hover">
                                                            <div class="d-flex flex-column">
                                                                <span class="custom-font-style-headings">0</span>
                                                                <span class="custom-font-style-small-text">New Issues</span>
                                                            </div>

                                                        </a>
                                                    </div>
                                                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                        <a href="#" class="custom-bg-warning p-4 custom-text-primary w-100 h-100 d-block card-hover-dark">
                                                            <div class="d-flex flex-column">
                                                                <span class="custom-font-style-headings">0</span>
                                                                <span class="custom-font-style-small-text">In Progress Issues</span>
                                                            </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 responsive-margin-card mt-5 h-50">
                                                        <div class="p-5 custom-bg-light-pale text-center custom-border-radius-15 h-100 custom-cursor-pointer">
                                                            <div class="mb-3 mt-2">
                                                                4
                                                            </div>
