                                ...
                                <div class="card w-100 rounded custom-padding-30">
                                    <div class="row">
                                        <div class="col-md-12 text-center">
                                            ...
                                            <div style="width: 100%;" class="d-flex justify-content-center custom-margin-top-40">
                                                <div style="width: 60%;">
                                                    <input type="range">
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="assesment-border m-5 custom-padding-40">
                                                    ...
                                                    <button class="assesment-card-btn p-2">
                                                        <span class="ml-2">
                                                            <svg width="28" height="23" viewBox="0 0 28 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                ...
                                                                <path d="M20.6227 9.95907C21.6819 9.95907 22.7417 9.9597 23.8009 9.95782C24.0009 9.95719 24.1929 9.97413 24.3497 10.1178C24.5558 10.3066 24.6583 10.5443 24.5891 10.8197C24.5132 11.122 24.2935 11.2876 23.9941 11.3366C23.8935 11.3529 23.7892 11.3447 23.6861 11.3447C21.6183 11.3453 19.5512 11.3453 17.4834 11.3453C17.4322 11.3453 17.3803 11.3466 17.3291 11.3447C16.9032 11.3284 16.5828 11.0141 16.5915 10.6215C16.5995 10.2664 16.918 9.96347 17.3204 9.96096C18.4216 9.95468 19.5222 9.95907 20.6227 9.95907Z" fill="#074A37" />
                                                                <path d="M19.4592 14.7665C20.1474 14.7665 20.835 14.764 21.5232 14.7671C22.0146 14.7696 22.3226 15.0488 22.3201 15.4784C22.3176 15.8655 22.0084 16.1484 21.5467 16.1502C20.1603 16.1571 18.774 16.1571 17.3883 16.1509C16.913 16.149 16.5846 15.8316 16.5988 15.4195C16.6118 15.045 16.942 14.7702 17.3957 14.7677C18.0833 14.764 18.7715 14.7665 19.4592 14.7665Z" fill="#074A37" />
                                                                <path d="M7.3845 6.5323C6.31481 6.5323 5.24574 6.53418 4.17605 6.53167C3.66683 6.53042 3.37363 6.27386 3.3687 5.83791C3.36438 5.42141 3.68287 5.14917 4.18717 5.14854C6.32592 5.14729 8.46468 5.14666 10.6034 5.14917C11.017 5.1498 11.2898 5.37311 11.3602 5.74445C11.417 6.04617 11.2522 6.33847 10.9547 6.47647C10.817 6.54045 10.6738 6.53167 10.5306 6.53167C9.48191 6.53293 8.4332 6.5323 7.3845 6.5323Z" fill="#074A37" />
                                                                <path d="M7.3896 14.7671C8.44879 14.7671 9.50799 14.7677 10.5672 14.7665C10.7659 14.7665 10.9591 14.7796 11.1141 14.9277C11.306 15.1108 11.4116 15.3304 11.3536 15.6007C11.2931 15.8824 11.1085 16.0499 10.8369 16.1201C10.7678 16.1377 10.695 16.1509 10.624 16.1509C8.45435 16.1527 6.28473 16.1559 4.1151 16.1502C3.72439 16.149 3.47811 15.9589 3.38737 15.6384C3.26022 15.188 3.58304 14.7759 4.08918 14.7696C4.89098 14.7596 5.6934 14.7665 6.49521 14.7665C6.79334 14.7671 7.09147 14.7671 7.3896 14.7671Z" fill="#074A37" />
                                                                <path d="M7.37467 9.95907C8.43386 9.95907 9.49306 9.95782 10.5516 9.9597C11.0393 9.96033 11.3633 10.2395 11.3707 10.6579C11.3781 11.0599 11.0386 11.3453 10.5442 11.346C8.40547 11.3466 6.26671 11.3472 4.12795 11.3447C3.7397 11.3441 3.46564 11.1446 3.3817 10.8166C3.30392 10.5142 3.44095 10.2037 3.71748 10.0469C3.86809 9.96158 4.03166 9.95907 4.19708 9.9597C5.25689 9.9597 6.31547 9.95907 7.37467 9.95907Z" fill="#074A37" />
                                                            </svg>
                                                ...
                                                <div class="d-flex justify-content-between align-items-center custom-margin assesment-button-responsive">
                                                    <div class="assesment-responsive">
                                                        <button class="assesment-light-btn d-inline-block assesment-responsive-btn-back">
                                                            Back
                                                        </button>
                                                    </div>
                                                    <div class="assesment-responsive-btn-block">
                                                        <button class="assesment-dark-btn d-inline-block mr-2">
                                                            Next
                                                        </button>
                                                        <button class="assesment-warning-btn d-inline-block">
                                                            Save
                                                        </button>
                                                    </div>
                                                </div>
