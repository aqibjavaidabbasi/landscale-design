<div id="kt_quick_cart" class="offcanvas offcanvas-right help-panal-border">
    ...
    <div class="d-flex align-items-center justify-content-between p-7 help-panal-border-bottom" kt-hidden-height="47">
        ...
        <a href="#" class="btn btn-xs btn-icon btn-hover-primary help-center-header-close" id="kt_quick_cart_close">
    ...
    <div class="row py-7 px-10">
        <div class="col-md-12 pl-0">
            <h6 class="help-center-font-family help-center-sub-head-text">Quick Access</h6>
        </div>
        <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12 help-quick-access p-5">
            <div class="d-flex flex-column align-items-center justify-content-center">
                <img src="../assets/media/feedback.png" alt="">
                <span class="help-quick-access-text mt-1">Assessment
                    Feedback</span>
            </div>
        </div>
        <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12 help-quick-access p-5 mx-5 responsive-margin-help">
            <div class="d-flex flex-column align-items-center justify-content-center">
                <img src="../assets/media/guideline.png" alt="">
                <span class="help-quick-access-text mt-1">View
                    Guidelines</span>
            </div>
        </div>
        <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12 help-quick-access p-5">
            <div class="d-flex flex-column align-items-center justify-content-center">
                ...
                <span class="help-quick-access-text mt-1">Report
                    Issue</span>
            </div>
        </div>
    </div>
