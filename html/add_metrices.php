                ...
                <div class="d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    <div class="container">
                        <div class="py-5">
                            ...
                            <span class="font-text text-lake">Add Metrices</span>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                                                ...
                                                                <div class="card">
                                                                    ...
                                                                    <div class="collapse border-bottom-secondary" id="collapseOneA">
                                                                        <div class="mx-10 mt-5">
                                                                            <table class="table table-vertical-center c-table-dark t-radius-15 text-light-primary text-primary p-table-15 border-light-primary">
                                                                                <thead>
                                                                                    <tr>
