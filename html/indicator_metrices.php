                                            ...
                                            <div class="p-4 steps-custom-height">
                                                <div class="row">
                                                    <div class="col-md-4 responsive-margin-card">
                                                        <div class="custom-padding-1 cards-tabs text-center h-100 custom-cursor-pointer">
                                                            <div class="mb-3 mt-2">
                                                    ...
                                                    <div class="col-md-4 responsive-margin-card">
                                                        <div class="custom-padding-1 cards-tabs text-center h-100 custom-cursor-pointer" id="kt_quick_cart_toggle">
                                                            <div class="mb-3 mt-2">
