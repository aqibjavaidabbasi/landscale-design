                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 custom-padding-0 pl-0 pr-0">
                                            <div class="card-wrapper h-100 p-5">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 responsive-margin-card">
                                                        <div class="p-5 custom-bg-light-pale text-center custom-border-radius-15 h-100 custom-cursor-pointer" id="kt_quick_cart_toggle">
                                                            <div class="mb-3 mt-2">
                                                ...
                                                <div class="row my-5-res" style="margin-top: 20px;">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 responsive-margin-card my-5-res">
                                                        <div class="p-5 custom-bg-light-pale text-center custom-border-radius-15 h-100 custom-cursor-pointer">
                                                            <div class="mb-3 mt-2">
                                                                <img src="../assets/media/Community_of_practice.png" alt="">
                                                            </div>
                                                    ...
                                                    <div class="accordion m-5" id="accordionExample">
                                                        <div class="bg-light d-none custom-btlr-15 custom-btrr-15" id="headingTwo-header">
                                                            <div class="btn btn-block text-left d-flex justify-content-between align-items-center indicator-accordian-responsive">
                                                                <span class="custom-font-style-subheadings">
                                                                    Indicator
                                                                </span>
                                                                <span class="p-1 custom-font-style-subheadings mr-35">Assigned To</span>
                                                            </div>
                                                        </div>
                                                                                ...
                                                                                <div class="p-5">
                                                                                    ...
                                                                                    <div class="row mt-5">
                                                                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                                                                            <button type="button" class="custom-bg-primary custom-text-light-pale custom-border-radius-35 border-0 px-3 py-2 align-items-center">
