                                                            ...
                                                            <div id="table_view" class="tabcontent">
                                                                <div class="row">
                                                                    <div class="col-sm-12 table-margin responsive-overflow-scroll">
                                                                        <table class="table border-grey text-primary text-dark-grey p-table-10 stripped dataTable table-responsive br-0" id="kt_datatable" role="grid" style="width: 1151px; margin-top: 0px !important;">
                                                                            <thead>
                                                                                <tr>
