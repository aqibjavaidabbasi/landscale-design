                                    ...
                                    <div class="row mt-5">
                                        <div class="col-md-6">
                                            <div class="step-card steps-custom-height custom-padding-40">
                                                ...
                                                <span class="frt-dark-clr p-2 w-25 step-radius d-inline-block mt-1">
                                                    <span>Approved</span>
                                                </span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row steps-custom-margin-top indicator-tab-container">
                                        <div class="col-md-3 col-sm-12 col-xs-12 indicator-padding-right-0">
                                            ...
                                            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                                <a class="nav-link indicator-tab-link active" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-home" role="tab" aria-controls="v-pills-home" aria-selected="true"><span class="indicator-nav-icon active"><img src="../assets/media/leaf_icon.png" alt=""></span><span class="indicator-custom-margin-left-10">Ecosystems</span></a>
                                                <a class="nav-link" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false"><span class="indicator-nav-icon"><img src="../assets/media/human.png" alt=""></span><span class="indicator-custom-margin-left-10">Human Well-being</span></a>
                                                <a class="nav-link" id="v-pills-messages-tab" data-toggle="pill" href="#v-pills-messages" role="tab" aria-controls="v-pills-messages" aria-selected="false"><span class="indicator-nav-icon"><img src="../assets/media/law.png" alt=""></span><span class="indicator-custom-margin-left-10">Governance</span></a>
                                                <a class="nav-link" id="v-pills-settings-tab" data-toggle="pill" href="#v-pills-settings" role="tab" aria-controls="v-pills-settings" aria-selected="false"><span class="indicator-nav-icon"><img src="../assets/media/trees.png" alt=""></span><span class="indicator-custom-margin-left-10">Production</span></a>
                                            </div>
                                        </div>
