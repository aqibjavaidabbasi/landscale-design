            ...
            <div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
                ...
                <div class="d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card w-100 card w-100 custom-padding-top-bottom custom-height-step-card">
                                    <div class="favourite-assesment-main-heading">Demo-LR Shayan</div>
                                    <p class="sub-heading my-5">This is your landscape dashboard. From here you can access your profile, the steps to conduct or update an assessment, the people involved in your assessment, and guidance.</p>
                                    <div class="smart-text my-5">
                                        Showcase Your Landscape
                                    </div>
                                    <p class="sub-heading">Create, manage, and publish your landscape profile.</p>
                                    <a href="#" class="frt-warning-clr d-flex justify-content-center align-items-center mt-2">
                                        <span class="mr-3">
                                            <svg width="15" height="17" viewBox="0 0 15 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M9.91706 8.03289C10.3151 8.13015 10.6803 8.24127 11.0342 8.38384C12.0458 8.79156 12.9284 9.37196 13.5758 10.2569C14.0659 10.9271 14.3288 11.6749 14.3318 12.5047C14.3337 13.0419 14.3356 13.5789 14.3312 14.1161C14.3226 15.1565 13.4746 15.9962 12.417 15.9975C9.24991 16.0015 6.08312 16.0015 2.91605 15.9975C1.86388 15.9962 1.01803 15.1642 1.00395 14.1281C0.996638 13.5954 1.00151 13.0627 1.00259 12.53C1.00503 11.475 1.4063 10.5778 2.13085 9.81592C3.01 8.89096 4.12309 8.37452 5.34936 8.06273C5.37535 8.05607 5.40162 8.05074 5.42734 8.04275C5.43465 8.04035 5.44006 8.03155 5.45035 8.02169C4.37923 7.23584 3.78437 6.19976 3.7684 4.87268C3.7554 3.81288 4.14556 2.90418 4.89746 2.15163C6.42887 0.618566 8.90307 0.614036 10.4423 2.15057C11.2857 2.99238 11.7057 4.01088 11.5947 5.20285C11.4839 6.38576 10.8734 7.2982 9.91706 8.03289ZM7.66706 15.0645C9.20118 15.0645 10.7353 15.0515 12.2691 15.0707C12.932 15.0789 13.4155 14.6446 13.3868 13.9752C13.3665 13.5008 13.382 13.0252 13.3833 12.5503C13.3839 12.3363 13.3608 12.1252 13.3097 11.9177C13.1361 11.2136 12.7311 10.6527 12.1806 10.1893C11.2917 9.44151 10.2403 9.04818 9.10208 8.85472C7.89341 8.64926 6.69232 8.69722 5.50748 9.00448C4.54466 9.25444 3.66091 9.66482 2.9415 10.363C2.29736 10.9884 1.9313 11.7333 1.95188 12.6428C1.96271 13.1176 1.95458 13.5928 1.9535 14.0679C1.95323 14.1798 1.96677 14.2888 2.00142 14.3954C2.13464 14.8069 2.50016 15.0632 2.97047 15.0637C4.53573 15.0653 6.10153 15.0643 7.66706 15.0645ZM7.65704 7.74935C9.26345 7.76054 10.6051 6.46038 10.6191 4.87881C10.6332 3.27939 9.31327 1.94964 7.69928 1.93738C6.07445 1.92486 4.72851 3.22369 4.7166 4.81592C4.70414 6.44865 5.99647 7.73789 7.65704 7.74935Z" fill="#074A37" stroke="#074A37" stroke-width="0.2" />
                                            </svg>
                            ...
                            <div class="col-md-6">
                                <div class="card w-100 card w-100 custom-padding-40 custom-height-step-card">
                                    <div class="row">
                                        <div class="col-md-4 responsive-margin-card">
                                            <div class="p-5 cards-tabs text-center h-100 custom-cursor-pointer">
                                                <div class="mb-3 mt-2">
                                        ...
                                        <div class="col-md-4 responsive-margin-card">
                                            <div class="p-5 cards-tabs text-center h-100 custom-cursor-pointer" id="kt_quick_cart_toggle">
                                                <div class="mb-3 mt-2">
                        ...
                        <div class="row mt-5">
                            <div class="col-md-12">
                                <div class="card w-100 card w-100 custom-padding-top-bottom">
                                    <div class="favourite-assesment-main-heading">Steps</div>
                                    <div class="row custom-padding-40">
                                        <div class="col-12 col-sm-6 col-md mb-2 custom-col-height">
                                            <div class="p-5 steps-tabs text-center h-100">
                                                ...
                                                <div class="child-bottom">
                                                    ...
                                                    <div>
                                                        <span class="bg-warning steps-tab-footer-radius pr-2 pl-2 responsive-footer-text">
                                                            6/6
                                                        </span>
                                                        <span class="frt-dark-clr steps-tab-footer-top-right-radius steps-tab-footer-bottom-right-radius pr-4 pl-2 responsive-footer-text">TASKS</span>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-12 col-sm-6 col-md mb-2 custom-col-height">
                                            <div class="p-5 steps-tabs text-center h-100 locked-background">
                                                ...
                                                <div class="child-bottom">
                                                    ...
                                                    <div>
                                                        <span class="bg-warning steps-tab-footer-radius pr-2 pl-2 steps-tab-footer-locked responsive-footer-text">
                                                        ...
                                                        <span class="frt-dark-clr steps-tab-footer-top-right-radius steps-tab-footer-bottom-right-radius pr-4 pl-2 steps-tab-footer-locked responsive-footer-text">Locked</span>
                                                    </div>
                                                </div>
