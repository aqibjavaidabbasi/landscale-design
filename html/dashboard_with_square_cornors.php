                ...
                <div class="d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="card w-100 card w-100" style="padding: 40px;">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="p-5 cards-tabs text-center">
                                                <div class="mb-3 mt-2">
                            ...
                            <div class="col-md-12">
                                <div class="card w-100 card w-100 custom-padding-top-bottom">
                                    ...
                                    <div class="row custom-padding-40">
                                        <div class="col-md-2">
                                            <div class="p-5 steps-tabs text-center">
                                                <div class="mb-3 mt-3">
                                                ...
                                                <div>
                                                    <span class="bg-warning steps-tab-footer-radius pr-2 pl-2">
                                                        6/6
                                                    </span>
                                                    <span class="frt-dark-clr steps-tab-footer-top-right-radius steps-tab-footer-bottom-right-radius pr-4 pl-2">TASKS</span>
                                                </div>
                                        ...
                                        <div class="col-md-2">
                                            <div class="p-5 steps-tabs text-center locked-background">
                                                <div class="mb-3 mt-3">
                                                ...
                                                <div>
                                                    <span class="bg-warning steps-tab-footer-radius pr-2 pl-2 steps-tab-footer-locked">
                                                        <!-- <img src="../assets/media/locked.png" alt=""> -->
                                                    ...
                                                    <span class="frt-dark-clr steps-tab-footer-top-right-radius steps-tab-footer-bottom-right-radius pr-4 pl-2 steps-tab-footer-locked">Locked</span>
                                                </div>
