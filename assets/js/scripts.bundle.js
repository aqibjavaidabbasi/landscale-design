...
var KTOffcanvas = function(elementId, options) {
    ...
    var Plugin = {
        ...
        hide: function() {
            ...
            //This lines is to hiden the zoom in buttons
...
KTUtil.ready(function() {
    ...
    // Init Quick HelpCenter Offcanvas Panel
    if (typeof KTLayoutHelpCenter !== 'undefined') {
        KTLayoutHelpCenter.init('kt_helpcenter');
    }
});
...
var KTLayoutQuickUser = function() {
    ...
    var _init = function() {
        ...
        _offcanvasObject = new KTOffcanvas(_element, {
            ...
            toggleBy: ['kt_quick_user_toggle','kt_quick_user_toggle2']
        });
